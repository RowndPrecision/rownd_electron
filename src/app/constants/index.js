...
export const FOUR_AXIS_DEVICE_MODE = 'PWM';
export const LATHE_DEVICE_MODE = 'ASDACN1';
export const LASER_DEVICE_MODE = 'LASER';
export const DEVICE_MODES = [FOUR_AXIS_DEVICE_MODE, LATHE_DEVICE_MODE, LASER_DEVICE_MODE];

export const GAMEPAD_BUTTONS = {
  FEEDRATE_INCREASE: 'FEEDRATE_INCREASE',
  FEEDRATE_DECREASE: 'FEEDRATE_DECREASE',
  SPEED_INCREASE: 'SPEED_INCREASE',
  SPEED_DECREASE: 'SPEED_DECREASE',
  MOVE_X_INCREASE: 'MOVE_X_INCREASE',
  MOVE_X_DECREASE: 'MOVE_X_DECREASE',
  MOVE_Z_INCREASE: 'MOVE_Z_INCREASE',
  MOVE_Z_DECREASE: 'MOVE_Z_DECREASE',
  MOVE_C_INCREASE: 'MOVE_C_INCREASE',
  MOVE_C_DECREASE: 'MOVE_C_DECREASE',
  SQUARE: 'SQUARE',
  TRIANGLE: 'TRIANGLE',
  CROSS: 'CROSS',
  CIRCLE: 'CIRCLE'
...
export const GAMEPAD_STICK_AXES = {
  X: 'X',
  Z: 'Z',
  C: 'C',
};
